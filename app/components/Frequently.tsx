...
const tog=(num:number)=>{
  ...
  return(
    <div className="flex justify-center w-full h-full items-center mt-30 mb-30">
        <div className="w-[66vw] h-[90%] flex flex-col justify-center items-center bg-[#53E26452] rounded-xl pb-14">
          <div className="text-[#1B5E20] text-[36px] font-poppins mt-8 mb-8">
          ...
          <Expendable exp={expanded[4]} onClick={()=>tog(4)} que=" Q: Can I sell my upcycled products on Eco Chain?"  ans="Yes! You can list handmade upcycled products in our marketplace and reach eco-conscious buyers looking for sustainable alternatives."/>
        </div>
    </div >
  )
}