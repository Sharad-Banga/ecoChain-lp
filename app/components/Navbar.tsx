...
export default function Navbar(){
  return(
    <div className="fixed z-10 w-full mt-[40px] flex justify-center">
        <div className="w-[80%] sm:w-[70%] md:w-[55vw] h-[58px] bg-white/70 backdrop-blur-md border-1 border-white rounded-lg drop-shadow-lg flex  justify-between pl-5 pr-3 items-center">
