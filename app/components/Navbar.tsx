...
export default function Navbar(){
  return(
    <div className="fixed z-10 w-full mt-[50px] flex justify-center">
        ...
        <div className="w-[55vw] h-[58px] bg-white rounded-lg drop-shadow-lg flex  justify-between pl-5 pr-3 items-center">

          <div className="font-geistsans font-bold text-[20px]">
            🌱   Eco<span className="text-[#00AA14]">Chain</span>
          </div>

          <div className="flex text-[18px] md:gap-7 justify-between font-poppins">
